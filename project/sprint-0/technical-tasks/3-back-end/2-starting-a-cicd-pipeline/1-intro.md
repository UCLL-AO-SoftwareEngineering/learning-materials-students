...
In these tasks we will start building CI/CD pipelines for the backend. The ultimate goal is that your
**default branch (normally "main")** will be built and deployed to Azure every time you push new code.
